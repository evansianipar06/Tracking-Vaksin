...
{
    public class PenggunaanVaksinController : Controller
    {
        // GET: PenggunaanVaksin
        ...
        {
            List<PenggunaanVaksinViewModel> StuList = db.PenggunaanVaksin.Where(x => x.status == false).Select(x => new PenggunaanVaksinViewModel
            {
                idUsed = x.idUsed,
